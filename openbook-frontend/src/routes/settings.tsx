    ...
    <div className="max-w-2xl mx-auto space-y-10 pb-12">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Configure OpenBook to suit your needs
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            />
            <p className="text-xs text-muted-foreground">
              The Ollama model to use e.g. llama3.2, gemma4:e2b, mistral
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <p className="text-sm font-medium text-foreground">Line height</p>
              <span className="text-xs text-muted-foreground">
                {lineHeight}
              </span>
            </div>
      ...
      <section className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Highlights the current line to help focus while reading
            </p>
          </div>
          <button
            onClick={toggleReadingRuler}
            className={`relative w-10 h-5 rounded-full transition-colors ${
              readingRuler ? "bg-primary" : "bg-muted"
            }`}
          >
            <span
              className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white transition-transform ${
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-4 text-center">
          <p className="text-sm text-muted-foreground leading-relaxed">
            OpenBook is free and open source. If it helps you or someone you
            know, consider supporting its development.
          </p>
